    ...
    <div class="row">
        ...
        <form method="post" action="<?= URL_ROOT; ?>register" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <small id="error-email" class="text-danger"><?php if (!empty($errors['emailError'])) { echo $errors['emailError']; } ?></small>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-6">
                    ...
                    <small id="error-password" class="text-danger"><?php if (!empty($errors['passwordError'])) { echo $errors['passwordError']; } ?></small>
                </div>

                <!-- Confirm Password-->
                <div class="form-group col-6">
                    <label for="confirm-password">Confirm password</label>
                    <input type="password" name="confirmPassword" id="input-confirm-password" value="<?= $data['confirmPassword']; ?>"
                    ...
                    <small id="error-confirm-password" class="text-danger"><?php if (!empty($errors['confirmPasswordError'])) { echo $errors['confirmPasswordError']; } ?></small>
                </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="streetAddress" id="input-street-address" value="<?= $data['streetAddress']; ?>"
                ...
                <small id="error-street-address" class="text-danger"><?php if (!empty($errors['streetAddressError'])) { echo $errors['streetAddressError']; } ?></small>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-8">
                    ...
                    <small id="error-city" class="text-danger"><?php if (!empty($errors['cityError'])) { echo $errors['cityError']; } ?></small>
                </div>
                ...
                <div class="form-group col-4">
                    ...
                    <small id="error-postcode" class="text-danger"><?php if (!empty($errors['postcodeError'])) { echo $errors['postcodeError']; } ?></small>
                </div>
            ...
            <div class="form-group">
                ...
                class="custom-select <?= (!empty($errors['countryError'])) ? 'is-invalid' : ''; ?>" aria-describedby="help-country">
                    <option value=""></option>
                ...
                <small id="error-country" class="text-danger"><?php if (!empty($errors['countryError'])) { echo $errors['countryError']; } ?></small>
            </div>
